...
public class TestInterceptor4 implements HandlerInterceptor{
	...
	// Controller의 메서드가 호출되기 전에 먼저 실행된다. 이 메서드가 false를 반환하면 요청 처리에 대한 진행은 중단된다.(로그인 처리에 사용) 
			...
			public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
				...
				System.out.println("TestInterceptor4 - preHandler 실행.");
				return true;
			}
			...
			public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
				...
				// TODO Auto-generated method stub
				System.out.println("TestInterceptor4 - postHandler 실행.");
			}
			...
			public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
					throws Exception {
				// TODO Auto-generated method stub
				System.out.println("TestInterceptor4 - afterCompletion 실행.");
			}	
}
